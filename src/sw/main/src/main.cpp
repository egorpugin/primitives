...
static ::cl::opt<bool, true> bt("bt", ::cl::desc("Print backtrace"), ::cl::location(gUseStackTrace), ::cl::Hidden, ::cl::sub(*::cl::AllSubCommands));
extern bool gDebugOnException;
static ::cl::opt<bool, true> doe("doe", ::cl::desc("Debug on Exception"), ::cl::location(gDebugOnException), ::cl::Hidden, ::cl::sub(*::cl::AllSubCommands));
static ::cl::alias bt2("st", ::cl::desc("Alias for -bt"), ::cl::aliasopt(bt));

extern std::string gSymbolPath;
static ::cl::opt<std::string, true> symbol_path("symbol-path", ::cl::desc("Set symbol path for backtrace"), ::cl::location(gSymbolPath), ::cl::Hidden, ::cl::sub(*::cl::AllSubCommands));

static ::cl::opt<int> sleep_seconds("sleep", ::cl::desc("Sleep on startup"), ::cl::Hidden, ::cl::sub(*::cl::AllSubCommands));
extern bool gPauseOnError;
static ::cl::opt<bool, true> pause_on_error("pause-on-error", ::cl::desc("Pause on program error"), ::cl::Hidden, ::cl::location(gPauseOnError), ::cl::sub(*::cl::AllSubCommands));
