...
struct PRIMITIVES_SOURCE1_API Source
{
...
struct PRIMITIVES_SOURCE1_API SourceUrl : Source
{
    String url;
...
struct PRIMITIVES_SOURCE1_API Git : SourceUrl
{
    String tag;
    String branch;
    String commit;
...
struct PRIMITIVES_SOURCE1_API Hg : Git
{
    int64_t revision;
...
struct PRIMITIVES_SOURCE1_API Bzr : SourceUrl
{
    String tag;
    int64_t revision = -1;
...
struct PRIMITIVES_SOURCE1_API Fossil : Git
{
    using Git::Git;
...
struct PRIMITIVES_SOURCE1_API Cvs : SourceUrl
{
    String tag;
    String branch;
    String revision;
...
struct PRIMITIVES_SOURCE1_API Svn : SourceUrl
{
    String tag;
    String branch;
    int64_t revision = -1;
...
struct PRIMITIVES_SOURCE1_API RemoteFile : SourceUrl
{
...
struct PRIMITIVES_SOURCE1_API RemoteFiles : Source
{
    StringSet urls;
